 ...
 */
final class Version20250508124818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE financial_informations ALTER COLUMN users_id INT
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE financial_informations ALTER COLUMN users_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
